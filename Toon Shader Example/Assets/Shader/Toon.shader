Shader "Roystan/Toon"
{
	Properties
	{
		...
		//Controls how smoothly the rim bends when approaching
		//unlit parts of the surface
		...
		SubShader
	{
		Pass
		{
			...
			//compile multiple versions of this shader depending on the light settings. 
			#pragma multi_compile_fwdbase
			
			#include "UnityCG.cginc"

			//Assists with lighting and shadows
